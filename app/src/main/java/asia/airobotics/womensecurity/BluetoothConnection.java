...
public class BluetoothConnection extends AppCompatActivity {
        ...
        if (mBTArrayAdapter == null) {
            ...
            sendbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    updateUi("Msg sent a;ready.. Again press..");
                }
            });
        }
    }
    ...
    private void SendToEmergencyMessage(String readMessage) {
        ...
        else if(readMessage==null)
        {
            ...
            String sendingPhoneNumber=UserPersonalDetails.getEmergency_phoneNumber();

            custom_message+=UserPersonalDetails.mapsUrl;
            sendingPhoneNumber=userPreferences.getString("userPhone","");

            Log.d(TAG, "SendToEmergencyMessage:msg:  "+custom_message);
